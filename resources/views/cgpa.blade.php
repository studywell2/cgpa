...
<body>
            ...
            <div class="results-section show">
                <div class="results-card">
                    ...
                    <div style="margin-top: 20px; display: flex; gap: 10px; flex-wrap: wrap;">
                        <a href="/analytics" class="btn btn-calculate" style="flex: 1; min-width: 150px; text-decoration: none;">
                            <span></span> View Grade Analytics
                        </a>
                        <a href="/grades" class="btn btn-calculate" style="flex: 1; min-width: 150px; text-decoration: none;">
                            <span>‹</span> View Your Grades
                        </a>
                        <a href="/pdf" class="btn btn-calculate" style="flex: 1; min-width: 150px; text-decoration: none;">
    ...
    <footer class="footer">
        ...
        <div class="footer-copyright">
            Â© {{ date('Y') }} University CGPA Calculator. Built with care for students.
        </div>
    ...
    <script>
        ...
        function addCourse(courseName = '', unitValue = '', gradeValue = 'A') {
            ...
            row.innerHTML = `
                ...
                <button type="button" class="remove-btn" onclick="removeCourse(this)" title="Remove course">Ã—</button>
            `;
        ...
        function updateRealtimeCgpa() {
            ...
            if (hasValidData && totalUnits > 0) {
                ...
                previewUnits.textContent = `ðŸ“Š ${totalUnits} Units`;
                previewPoints.textContent = `â­ ${totalPoints.toFixed(1)} Points`;
